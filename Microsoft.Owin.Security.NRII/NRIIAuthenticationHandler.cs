...
{
    public class NRIIAuthenticationHandler : AuthenticationHandler<NRIIAuthenticationOptions>
    {
        ...
        public NRIIAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new NRIIReturnEndpointContext(Context, ticket);
